...
class ClothingItem(models.Model):
    ...
    def hex_to_hsl(self):
        """
        Converts the stored hex color (#rrggbb) to HSL format.
        Returns: (H, S, L) with H in degrees (0-360), S and L in percent (0-100)
        """
    ...
    def get_hue(self):
        """
        Returns the hue component of the color in degrees (0-360).
        """
